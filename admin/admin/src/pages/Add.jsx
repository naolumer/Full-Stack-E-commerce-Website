    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3' >
      ...
      <div className='flex flex-col sm:flex-row gap-2 w-full sm:gap-8  '>
        ...
        <div>
          ...
          <input onChange={(e)=>setPrice(e.target.value)} className='w-full px-3 py-2 sm:w-[120px]' value={price} type="Number" placeholder='25'/>
        </div>
      </div>
      ...
      <div className='flex gap-2 mt-2'>
        <input onChange={()=>setBestseller(prev=> !prev)}  className='w-4' checked={bestseller} type="checkbox" id="bestseller" />
